...
<body>
   ...
   <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="index.php"><img src="img/download.png" alt="" title="" /></img></a>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li id="sdt"><a href="#ab">Mentee Details</a></li>
          <li id="count"><a href="#port">Total Male And Female Students</a></li>
          <li id="ia"><a href="#t">Mentee Internal Marks</a></li>
          <li id="miav"><a href="#t">Average Marks</a></li>
          <li id="rmv"><a href="mentorshow.php">Remove Mentee</a></li>
  ...
  <section
  style="
    background-image: url(./img/sahyadri.jpg)" class="hero">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-12">
          <a class="hero-brand" href="index.php" title="Home"><img alt="Sahyadri Logo" src="img/download.png" width="70" height="70"></a>
        </div>
      </div>
       ...
       <div class="col-md-6">
        <div class="card">
          <div class="card-header">
            <h3 class="text-center">Enter Mentee Details</h3>
          </div>
  ...
  <section id="sdetail">
    ...
    <div class='container'>
      <div class='card'>
        <h3 class='text-center'>Mentee Detail</h3>
